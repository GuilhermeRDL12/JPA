...
/**
 * 
 * T_EMPRESA *cd_empresa (NUMBER) (PK) (Sequence SQ_T_EMPRESA) *nm_fantasia
 * (VARCHAR(50)) dt_abertura (DATE) ds_status (VARCHAR) (Enum) *nr_cnpj
 * (VARCHAR(18))
 */
...
public class Empresa {
	...
	public Empresa(String nomeFantasia, Calendar dataAbertura, String status, String cnpj) {
		super();
		this.nomeFantasia = nomeFantasia;
		this.dataAbertura = dataAbertura;
		this.status = status;
